...
public class AssocRuleMining extends JFrame {
    ...
    public AssocRuleMining(AssocRuleMining armInstance) {
        ...
        hasOutputSchemaFlag = armInstance.hasOutputSchemaFlag;
        }
...
//System.out.println("Proceed down right branch");
   ...
   /** Sets reference to start of the given output schema array.
   ...
   public void setOutputSchemaArray(String[] outputSchemaRef) {
    ...
    /* ----------------------- */
    /* OUTPUT RULE BINARY TREE */
    /* ----------------------- */

    /** Outputs contents of rule binary tree (if any), with re-conversion if
    necessary, asuming that the tree represents a set of ARs or CARS.	*/

    public void outputRules() {
        outputRules(startRulelist);
	}

    /** Outputs contents of rule binary tree (if any) to the file indicated by 
    <TT>fileOutput</TT> field, with re-conversion if necessary, asuming that 
    the list represents a set of ARs or CARS.	*/
    ...
    /** Outputs a single rule asuming that the rule represents an AR.
